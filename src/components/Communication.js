...
const Communication = props =>
  <div className="auth">
    <div className="media-controls">    
      ...
      <button data-tip='Record On/off' data-for='btnrecord' onClick={props.toggleRecord} className={'record-button-' + !JSON.parse(localStorage.getItem('PRCUser_Record'))}>
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 426.667 426.667" style={{enableBackground: 'new 0 0 426.667 426.667'}} xmlSpace="preserve" className="svg">
          ...
          <path className="off" d="M213.333,149.333c-35.307,0-64,28.693-64,64s28.693,64,64,64s64-28.693,64-64S248.64,149.333,213.333,149.333z" />         
        </svg>
      </button>
